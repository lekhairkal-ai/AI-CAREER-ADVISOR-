...
st.markdown("Your AI Career Advisor that can search the web for real-time career information with a distinctive personality!")
...
# Chat input
if prompt := st.chat_input("Ask me about the latest career information..."):
    ...
    if st.session_state.agent is None:
        ...
        with st.chat_message("assistant"):
            with st.spinner("🔍 Searching for career information..."):
                try:
